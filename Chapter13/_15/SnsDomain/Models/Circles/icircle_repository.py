...
class ICircleRepository:
    ...
    def find_satisfied_by(self, specification: ISpecification) -> List[Circle]:
        pass


if __name__ == '__main__':
    class MockSpecification(ISpecification):
    ...
    print(circle_repository.find_satisfied_by(specification))