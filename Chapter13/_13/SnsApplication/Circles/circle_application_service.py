...
from circle_recommend_specification import CircleRecommendSpecification
...
class CircleApplicationService:
    ...
    def get_recommended(self, request: CircleGetRecommendRequest) -> CircleGetRecommendResult:
        recommend_circle_spec = CircleRecommendSpecification(self.now)
        circles = self.circle_repository.find_all()
        recommeded_circles = [circle for circle in circles if recommend_circle_spec.is_satisfied_by(circle)]
