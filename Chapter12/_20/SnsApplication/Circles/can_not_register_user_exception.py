...
class CanNotRegisterCircleException(Exception):
    def __init__(self, circle: Circle, message: str):
        super().__init__(message)
        self._id = circle.id.value
...
if __name__ == '__main__':
    ...
    try:
        raise CanNotRegisterCircleException(circle, 'Registration failed.')
    except CanNotRegisterCircleException as e:
        print(f'Error: {e}')
