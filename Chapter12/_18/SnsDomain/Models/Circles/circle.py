...
class Circle:
    ...
    def change_member_name(self, target_id: UserId, new_name: UserName) -> None:
...
if __name__ == '__main__':
    ...
    circle.change_member_name(UserId('userid1'), UserName('changename1'))

    for member in circle.members:
        print(member.id.value, member.name.value)
