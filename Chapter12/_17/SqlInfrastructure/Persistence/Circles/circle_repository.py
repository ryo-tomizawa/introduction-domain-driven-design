...
if __name__ == '__main__':
    ...
    create_query_1 = 'CREATE TABLE circles(id text primary key, name text, ownerid text);'
    create_query_2 = 'CREATE TABLE userCircles(circleid text primary key, userid text);'
